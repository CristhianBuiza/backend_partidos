...
export interface ApiInicioConfiguracionInicioConfiguracion
  ...
  info: {
    singularName: 'inicio-configuracion';
    pluralName: 'inicio-configuracions';
    displayName: 'Inicio Configuracion';
    description: '';
  };
  options: {
    draftAndPublish: false;
...
export interface ApiWebConfiguracionWebConfiguracion extends Schema.SingleType {
  collectionName: 'web_configuracions';
  info: {
    singularName: 'web-configuracion';
    pluralName: 'web-configuracions';
    displayName: 'Web Configuracion';
  };
  options: {
